...
export default function NewRequestPage() {
  return (
    <div className="mx-auto max-w-3xl">
      <p className="mb-2 text-xs font-semibold text-accent">ATC Proof of Concept</p>
      <h1 className="text-3xl font-bold tracking-tight text-accent">What do you need to prove?</h1>
